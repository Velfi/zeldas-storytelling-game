...
Chicago_Wall_Segment :: struct {
	ax, ay, bx, by, width: f64,
}
Chicago_Wall_Door :: struct {
	ax, ay, bx, by, width: f64,
}
Chicago_Wall_Point :: struct {
	x, y: f64,
}
Chicago_Wall_Contour :: struct {
	first, count: u32,
	is_hole:      i32,
}
Chicago_Wall_Geometry :: struct {
	points:        ^Chicago_Wall_Point,
	point_count:   u32,
	contours:      ^Chicago_Wall_Contour,
	contour_count: u32,
}
